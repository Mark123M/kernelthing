"""Seed kernel for cholesky_b1n8192 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(1, 8192, 8192)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b1n8192/cholesky_b1n8192.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=1, n=8192 (benchmark index 12); everything
