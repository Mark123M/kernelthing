"""Seed kernel for cholesky_b16n512 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(16, 512, 512)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b16n512/cholesky_b16n512.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=16, n=512 (benchmark index 4); everything
