"""Seed kernel for cholesky_b1n4096 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(1, 4096, 4096)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b1n4096/cholesky_b1n4096.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=1, n=4096 (benchmark index 10); everything
