"""Seed kernel for cholesky_b2n4096 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(2, 4096, 4096)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b2n4096/cholesky_b2n4096.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=2, n=4096 (benchmark index 11); everything
