"""Seed kernel for cholesky_b2n2048 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(2, 2048, 2048)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b2n2048/cholesky_b2n2048.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=2, n=2048 (benchmark index 8); everything
