"""Seed kernel for cholesky_b64n256 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(64, 256, 256)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b64n256/cholesky_b64n256.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=64, n=256 (benchmark index 3); everything
