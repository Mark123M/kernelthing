"""Seed kernel for cholesky_b1n32768 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(1, 32768, 32768)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b1n32768/cholesky_b1n32768.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=1, n=32768 (benchmark index 14); everything
