"""Seed kernel for cholesky_b1n16384 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(1, 16384, 16384)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b1n16384/cholesky_b1n16384.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=1, n=16384 (benchmark index 13); everything
