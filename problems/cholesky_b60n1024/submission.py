"""Seed kernel for cholesky_b60n1024 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(60, 1024, 1024)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b60n1024/cholesky_b60n1024.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=60, n=1024 (benchmark index 7); everything
