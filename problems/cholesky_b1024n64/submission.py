"""Seed kernel for cholesky_b1024n64 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(1024, 64, 64)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b1024n64/cholesky_b1024n64.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=1024, n=64 (benchmark index 1); everything
