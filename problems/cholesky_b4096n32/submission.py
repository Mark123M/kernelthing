"""Seed kernel for cholesky_b4096n32 -- FILL THIS IN.
...
- Entry point is ``custom_kernel(data: input_t) -> output_t``. ``data`` is a
  ``(4096, 32, 32)`` fp32 CUDA tensor of SPD matrices; return lower-triangular
...
``/home/mark123/projects/linalg/cholesky/b4096n32/cholesky_b4096n32.py``.
"""
...
def custom_kernel(data: input_t) -> output_t:
    # TODO: specialise batch=4096, n=32 (benchmark index 0); everything
